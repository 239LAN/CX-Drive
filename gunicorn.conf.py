...
from config import env_get, load_site_config  # noqa: E402

_site = load_site_config()

# 监听地址，可用环境变量 REALFILES_BIND 覆盖（兼容旧的 CLOUDPAN_BIND）
bind = env_get("BIND", "0.0.0.0:4280")
